...
public final class ProjectConstant {
    ...
    public static final String POJO_PACKAGE = BASE_PACKAGE + ".pojo";
    /*生成的Pojo所在包*/

    public static final String MODEL_PACKAGE = POJO_PACKAGE + ".model";
    /*生成的Model所在包*/

    public static final String MAPPER_PACKAGE = POJO_PACKAGE + ".dao";
    /*生成的Mapper所在包*/
